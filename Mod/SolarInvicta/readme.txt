...
3. Install this mod in the game
4. Restart the game twice
5. Download and install Unity mod manager 0.25.0 and later versions at https://www.nexusmods.com/site/mods/21, this is a tool for reading MOD, do not install MOD through this
6. Put the regionoutlines in the Terra Invicta\Mods\ (Enabled or Disabled)\SolarInvicta folder into
...
3.在游戏里安装这个MOD
4.重启游戏两次
5.在 https://www.nexusmods.com/site/mods/21 下载安装Unity mod manager 0.25.0及以后的版本，这就是个读取MOD的工具，别通过这个安装MOD
